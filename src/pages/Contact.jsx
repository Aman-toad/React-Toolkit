        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-4">
            ...
            <input
              ...
              required
              className="w-full bg-[#111] rounded-xl p-4 text-xl border border-slate-950 focus:border-gray-500 focus:outline-none placeholder:text-gray-600"
            />
          </div>
          ...
          <div className="space-y-4">
            ...
            <textarea
              ...
              required
              rows={6}
              className="w-full bg-[#111] rounded-xl p-4 text-xl border border-slate-950  focus:border-gray-500 focus:outline-none placeholder:text-gray-600 resize-none"
            />
          </div>
